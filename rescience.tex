...
A \textit{reproducible replication} is a replication whose code and data has been archived and documented for reproducibility. Within the current state of the art of computational science, it is the most detailed and accurate possible description of a computational method.
